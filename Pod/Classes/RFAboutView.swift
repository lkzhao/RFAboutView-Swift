...
open class RFAboutViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,MFMailComposeViewControllerDelegate,SFSafariViewControllerDelegate {
    ...
    open override func loadView() {
        ...
        if let _ = websiteURL {
            var buttonFont = UIFont.systemFont(ofSize: sizeForPercent(4.375))
    ...
    open override func viewWillAppear(_ animated: Bool) {
        ...
        navigationController?.navigationBar.titleTextAttributes = [.foregroundColor: navigationBarTitleTextColor]
    ...
    open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell==nil {
            ...
            cell?.textLabel?.font = UIFont.systemFont(ofSize: sizeForPercent(4.688))
    ...
    private func createAndAddNameLabel(headerView: UIView) -> UILabel {
        ...
        appNameLabel.font = UIFont.systemFont(ofSize: sizeForPercent(5.625))
    ...
    private func createAndAddCopyrightLabel(headerView: UIView) -> UILabel {
        ...
        copyrightInfo.font = UIFont.systemFont(ofSize: sizeForPercent(4.375))
    ...
    private func createAndAddTableHeaderLabel(scrollViewContainer: UIView) -> UILabel {
        ...
        tableHeaderLabel.font = UIFont.systemFont(ofSize: sizeForPercent(4.375))
